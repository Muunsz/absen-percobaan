import { KelasAgenda } from "@/lib/agenda-kelas-page-utils"
import {
    BookOpen,
    Clock,
    Edit3,
...
interface AgendaTableProps {
    agendaList: KelasAgenda[]
    deletingId: number | null
    onDelete: (id: number) => void
    onEdit: (agenda: KelasAgenda) => void
}

export default function AgendaTable({ agendaList, deletingId, onDelete, onEdit }: AgendaTableProps) {
    return (
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                            <th className="min-w-[120px] px-4 py-3 text-left font-bold text-gray-900 dark:text-white uppercase tracking-wider">Jam</th>
                            <th className="min-w-[150px] px-4 py-3 text-left font-bold text-gray-900 dark:text-white uppercase tracking-wider">Guru</th>
                            <th className="min-w-[150px] px-4 py-3 text-left font-bold text-gray-900 dark:text-white uppercase tracking-wider">Mata Pelajaran</th>
                            <th className="min-w-[200px] px-4 py-3 text-left font-bold text-gray-900 dark:text-white uppercase tracking-wider">Materi</th>
                            <th className="min-w-[150px] px-4 py-3 text-left font-bold text-gray-900 dark:text-white uppercase tracking-wider hidden md:table-cell">Keterangan</th>
                            <th className="min-w-[120px] px-4 py-3 text-center font-bold text-gray-900 dark:text-white uppercase tracking-wider hidden sm:table-cell">Dokumentasi</th>
                            <th className="min-w-[100px] px-4 py-3 text-center font-bold text-gray-900 dark:text-white uppercase tracking-wider">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-left hidden md:table-cell">
                                        {agenda.keterangan ? (
                                            <span className="text-xs text-gray-600 dark:text-gray-400 italic line-clamp-2">{agenda.keterangan}</span>
                                        ) : (
                                    ...
                                    <td className="px-4 py-3 text-center flex items-center justify-center gap-2 whitespace-nowrap">
                                        <button
