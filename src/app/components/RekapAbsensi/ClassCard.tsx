    ...
    >
      ...
      <div className="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100 dark:border-gray-700/50">
        <button
          ...
          disabled={isLulusan} 
          className="flex-1 text-sm px-3 py-1.5 rounded-lg bg-gray-900 text-white hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-200 transition-colors font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
        ...
        <button
          onClick={onToggle}
          className={`w-20 text-sm px-3 py-1.5 rounded-lg transition-colors font-medium ${
            isSelected
