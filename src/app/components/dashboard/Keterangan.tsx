...
export default function Keterangan({ sakit, izin, alfa }: Props) {
  const cards = [
    { label: "Total Sakit Hari Ini", value: sakit, href: "/admin/dashboard/detail/sakit" },
    { label: "Total Izin Hari Ini", value: izin, href: "/admin/dashboard/detail/izin" },
    { label: "Total Alfa Hari Ini", value: alfa, href: "/admin/dashboard/detail/alfa" },
  ];
