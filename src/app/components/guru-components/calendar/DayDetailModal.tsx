// app/components/guru-components/calendar/DayDetailModal.tsx
"use client";
          ...
          <div className="mt-4 md:mt-0 md:pl-6 border-t md:border-t-0 md:border-l border-gray-200 dark:border-gray-700 pt-4 md:pt-0">
            ...
            {activeEvent && (
              <div className="space-y-5">
                ...
                <div className="pt-4">
                  <Link href="/guru/daftar-hadir" className="w-full bg-green-600 hover:bg-green-500 text-white rounded-lg px-4 py-2.5 text-sm transition-colors font-medium shadow-md block text-center">
                    Lihat Daftar Hadir
                  </Link>
                </div>
              </div>
