...
import { BreadcrumbNav } from "../../../components/Agenda-guru/BreadcrumbNav";
import { KelasCard } from "../../../components/Agenda-guru/KelasCard"  ;
          ...
          {filtered.length === 0 && !error ? (
            ...
            filtered.map((k) => (
              <KelasCard
                ...
                label={k.kelas}
                color={color}
                href={`/guru/isi-agenda/${jurusanParam}/${encodeURIComponent(
